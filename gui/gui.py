...
class Ui_GameWindow(object):
    def setupUi(self, GameWindow):
        ...
        self.destLangBox = QtWidgets.QComboBox(self.horizontalLayoutWidget)
        self.destLangBox.setObjectName("destLangBox")
        self.destLangBox.addItem("")
        self.destLangBox.addItem("")
        self.horizontalLayout.addWidget(self.destLangBox)
    ...
    def retranslateUi(self, GameWindow):
        ...
        self.sourceLangBox.setItemText(1, _translate("GameWindow", "Español"))
        self.toLabel.setText(_translate("GameWindow", "To"))
        self.destLangBox.setItemText(0, _translate("GameWindow", "Español"))
        self.destLangBox.setItemText(1, _translate("GameWindow", "English"))
